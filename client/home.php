...
<body ng-controller="GetRequestController" ng-init="getAllFeeds()" class="mx-auto d-flex flex-column vh-100">
    ...
    <div class="mx-auto d-flex flex-row h-90 w-50"> 
        ...
        <!-- News feed summary column -->
        <div id="feed-summary-tab" class="border rounded helv-bold d-flex flex-column w-75">
            <!-- individual feed summaries -->
            <div class = "overflow-auto">
                <div ng-repeat="feed in feeds" class="d-flex flex-row border-bottom pt-2 ps-1 pb-2">
                    <div id="feed-summary-profpic">
                        <img id="feed-summary-profile-pic" src="../images/profilepic.jpg" alt="profile picture" />
                    </div>
                    <div id="feed-summary-info" class="d-flex flex-column flex-grow-1">
