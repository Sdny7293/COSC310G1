			...
			<li class="list-group-item">
				<nav  class="navbar navbar-light bg-light">
					<a id = "navbar" class="navbar-brand" href="#">
						<span class="Column1">					
							<img  src="/images/icon.png" alt="logo" width="80" height="40">
						</span>
						<span class="Column2">
				...
				<ul class="list-group list-group-flush">
						<li class="list-group-item">
							...
							<p>Without it we wouldn't have the growing selection of electric vehicles we have today, 
								...
								<span class="Col1">
								<a href="#">
									<i onclick="myFunction(this)" class="fa fa-thumbs-up" alt="logo"></i>
									<script>
										function myFunction(x) {
											x.classList.toggle("fa-thumbs-down");
										  }
									</script>
									<!--<img id="like" src="/images/like.png" class="fa fa-thumbs-up" onlick="myClick(e)" alt="like" width="20" height="20"> -->
									<img id="comment" src="/images/comment.png" alt="comment" width="20" height="20">
