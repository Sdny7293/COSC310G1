...
<body>
    <header>
        <?php include '../navBar/navBar.php' ?>
                    ...
                    <!-- test by FX -->
                    <!-- <div id='fxHTML' class='fxHTML'>test</div> -->

                    <div id='messages_fx' class='messages_fx'>dede</div>

                    <div> <!--  ng-controller='GetRequestController' -->
                        dededededed
                        <div id='fxHTML' class='fxHTML'>  <!-- ng-repeat='message in messages' -->
                            {{message.time}}: {{message.name}} says {{message.message}}
                        </div>
                    </div>
            ...
            <div class="col border col-margin position-relative">
                ...
                <div class="row border m-auto" id="menu" >
                    <div class="col text-start border">
                        <div id="msg-sender-profile-name" class="row helv-bold pt-1" ng-repeat = "message in students">{{ message.name }}
                            <p class="mb-0 fs-7"></p>
                        </div>
                ...
                <div id="chatbox">
                    ...
                    <div id="message-sender-profile">
                        ...
                        <p id="header-name" class="helv-bold" ng-model = "messages"><span id="connection" class="text-muted helv-reg fs-7"> • 1st</span></p>
                    ...
                    <div id="chat-messages">
                        ...
                        <div id="message-sender" class="row">
                            ...
                            <div class="col pt-1">
                                <p class="helv-bold fs-7 mb-0 ms-2"><span class="text-muted fs-8 helv-reg"> • 10:02 AM</span></p>
                                <!-- message content -->
                    ...
                    <div id="chat-messages">
                        ...
                        <div id="message-sender" class="row">
                            ...
                            <div class="col pt-1">
                                <p class="helv-bold fs-7 mb-0 ms-2">{{x.date}}<span class="text-muted fs-8 helv-reg">{{x.time}}</span></p>
                                <!-- message content -->
...
var testArr = [
    ...
    {name: 'Mary', message: 'Not bad.', time: '10:02'}
		...
		function GetRequestController($scope, $http) {
			...
			$scope.sendMsg = function() {
				...
				$http.get('../backend/messageController.php', { ///EchoServlet/echoserve will be my php file
					...
					.success(function(data, status, headers, config) {
						// alert(data)
                        // $scope.messages_fx = 'hello'
                        // testFlag = true;
                        // const obj = JSON.parse('{"content":"hellooooooooo"}')
                        // const obj = JSON.parse(data)
                        $data = json_decode(data);
                        document.getElementById("messages_fx").innerHTML = $data;
					})
            ...
            // if(testFlag) {
            //     $scope.messages = testArr;
            // }
		}

		function FXController($scope) {
            $scope.testBind = 'hellow'
                        // $scope.messages = testArr
		}
